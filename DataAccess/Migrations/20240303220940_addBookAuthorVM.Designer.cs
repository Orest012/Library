...
namespace DataAccess.Migrations
{
    ...
    [Migration("20240303220940_addBookAuthorVM")]
    partial class addBookAuthorVM
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuthorBookAuthorMap", b =>
                {
                    ...
                    b.HasKey("AuthorId", "BookAuthorMapAuthor_Id", "BookAuthorMapBook_Id");

                    b.HasIndex("BookAuthorMapAuthor_Id", "BookAuthorMapBook_Id");
            ...
            modelBuilder.Entity("Models.Models.Author", b =>
                {
                    ...
                    b.Property<int?>("BookAuthorVMIdBook")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Models.ViewModels.BookAuthorVM", b =>
                {
                    b.Property<int>("IdBook")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("bookAuthorVMs");
                });

            modelBuilder.Entity("AuthorBookAuthorMap", b =>
                {
                    b.HasOne("Models.Models.Author", null)
                        .WithMany()
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Models.Models.BookAuthorMap", null)
                        .WithMany()
                        .HasForeignKey("BookAuthorMapAuthor_Id", "BookAuthorMapBook_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Models.Models.Author", b =>
                {
                    b.HasOne("Models.ViewModels.BookAuthorVM", null)
                        .WithMany("AuthorList")
                        .HasForeignKey("BookAuthorVMIdBook");
                });
